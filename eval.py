...
def blending(img, mask):
    ...
    img_b = np.where(mask == 127, img_b * 2 + 127, img_b)
    img_g = np.where(mask > 127, img_g * 2 + 127, img_g)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', default='./results/20220613171535/models/31.pth', type=str, help='path to latest checkpoint')
